            ...
            <div class="row" >
                <div class="col">
                    <div class="card shadow border-0">
                        <div id="map-canvas" class="map-canvas" data-lat="40.748817" data-lng="-73.985428" style="height: 2900px;">
...
// import uplodResult from './AdminPanel/Results/DhUploadResults'
  export default {
    ...
    mounted() {
        this.$http.get('http://localhost:8000/api/getAllRepeatedSubjects/16_ENG_007')
