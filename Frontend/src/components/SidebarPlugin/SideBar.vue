    ...
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
        <div class="container-fluid">
            ...
            <router-link class="navbar-brand" to="/">
                <b-row>
                  <b-col cols="4">
                    <img src="img/brand/usjp.png" class="navbar-brand-img" alt="...">
                
                  </b-col>
                  <b-col cols="8" style="margin-left:-23px;">
                    <h6>University of Srijayawardanapura <br> Faculty of Engineering </h6>
                    <h6>Admin Panel</h6>
                  </b-col>
                </b-row>
            </router-link>
                        ...
                        <a slot="title" class="nav-link" href="#" role="button">
                            <div class="media align-items-center">
                              <span class="avatar avatar-sm rounded-circle">
                                <img alt="Image placeholder" src="img/brand/usjp.png.jpg">
                              </span>
                            </div>
                        </a>
